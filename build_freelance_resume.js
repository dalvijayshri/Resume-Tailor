...
// Load global docx
const GLOBAL_NODE_MODULES = 'C:\\Users\\jadha\\AppData\\Roaming\\npm\\node_modules';
const docx = require(path.join(GLOBAL_NODE_MODULES, 'docx'));
...
function tr(text, extra = {}) {
  return new TextRun({ text, font: FONT, size: extra.size ?? 22, bold: extra.bold, italics: extra.italics, color: extra.color });
}
...
// Job header with right-aligned date
...
const sections = [{
  ...
  children: [
    ...
    // -------- Page break before experience for clarity --------
...
const outPath = 'C:\\Users\\jadha\\Downloads\\Jayshri Dalvi Resume Freelance Upwork.docx';
