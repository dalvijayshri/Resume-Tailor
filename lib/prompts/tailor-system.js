...
- skills:         6-8 category rows. Items are rendered as a 2-column
                  ...
                  items string ~100-140 chars. Format rules:
                    ...
                    - .NET VERSION RULE: When mentioning a specific .NET
                      version, ALWAYS use ".NET 8" or ".NET Core 8" — the
                      candidate works on the current LTS line. Do NOT
                      output ".NET 7", ".NET Core 7", ".NET 6", or any
                      older version even if the JD references them.
                      Versionless ".NET" or ".NET Core" remains fine.
                    - NATURAL CASING for proper nouns and acronyms — never
                      lowercase technology names. Use exactly:
                        ".NET", ".NET 8", ".NET Core", ".NET Core 8",
                        "C#", "F#", "Java", "Python",
...
- projects:       MANDATORY when the resume mentions any personal /
                  ...
                  Establish the current-learning nature inside the
                  project DESCRIPTION (the "stack" field or the first
                  bullet) with phrasing like:
                    "Ongoing self-paced build — actively maintained,
                     no fixed timeline."
                    "Current learning project — refreshed as new
                     tools and patterns emerge."
                    "Self-directed practice; iterating in the open
                     with the latest stack."
                  Pick wording that fits the rest of the resume voice;
                  do not copy these examples verbatim every time.
