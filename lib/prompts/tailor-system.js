...
type TailoringResult = {
  ...
  tailoredResume: {
    ...
    filenameSlug: string;             // REQUIRED. Short kebab-case slug for the
                                      // downloadable filename, derived ONLY from
                                      // the JD's company name + role title.
                                      // RULES (strict):
                                      //   - DO NOT include the candidate's name
                                      //     (the candidate's name is prefixed
                                      //     automatically by the file server).
                                      //   - 15-40 chars total, lowercase
                                      //   - hyphens only, no underscores or
                                      //     special characters
                                      //   - format: "<company>-<role>"
                                      // Examples:
                                      //   JD = "L'EVATE Senior .NET Developer"
                                      //     → "levate-senior-net-developer"
                                      //   JD = "Acme Co — Java/Spring Architect"
                                      //     → "acme-java-spring-architect"
  };
  proposalOrMessage: {
