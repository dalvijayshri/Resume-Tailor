...
type TailoringResult = {
  ...
  tailoredResume: {
    ...
    summary: string;                  // 3-5 sentences rewritten for THIS JD
    skills: Array<{                   // grouped skill list, ATS-friendly
    ...
    experience: Array<{
      ...
      bullets: string[];              // reordered + reworded for JD; keep truthful
    }>;
    education: string;
    projects?: Array<{                // optional — for ElixaX-style entries
      name: string;
      dates: string;
      stack: string;
      bullets: string[];
