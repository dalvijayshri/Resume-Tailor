...
- projects:       MANDATORY when the resume mentions any personal /
                  ...
                  (b) JD is in the NON-HEALTHCARE family:
                      ...
                      DATES — special rule for non-healthcare framing:
                      Set the project's \`dates\` field to an empty
                      string (""). DO NOT include "Jan 2026 – Present",
                      "Present", "Ongoing", a year, or any date marker
                      in the dates field. The project must read as an
                      open-ended, continuously up-to-date learning
                      effort rather than a time-boxed delivery.
                      Establish this in the project DESCRIPTION (the
                      "stack" field or the first bullet) with phrasing
                      like:
                        "Ongoing self-paced exploration — actively
                         maintained, no fixed timeline."
                        "Continuous learning project — refreshed as
                         new tools and patterns emerge."
                        "Self-directed AI / full-stack practice;
                         iterating in the open."
                      Pick wording that fits the rest of the resume
                      voice; do not copy these examples verbatim every
                      time.
