...
- projects:       1-2 personal/freelance project entries IF the resume
                  describes such projects (e.g. side projects, OSS, solo
                  builds). 3-4 bullets each. If the resume has none, omit.
