...
export const meta = {
  id: 'v3-elixax-last',
  name: 'Original (2-page, default)',
  description: 'The standard 2-page resume — ElixaX as personal project at the bottom. Loaded by default in the JD tailoring tool, and is the master copy you can hand to recruiters as-is.',
  filename: 'Jayshri_Dalvi_Resume_Original.docx',
  // Path on the public CDN (writes to public/downloads/<publicFilename>).
  // Other variants fall back to `<id>.docx` if publicFilename is omitted.
  publicFilename: 'Jayshri_Dalvi_Resume_Original.docx',
};
