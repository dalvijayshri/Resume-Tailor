...
export const meta = {
  id: 'v3-elixax-last',
  name: 'Standard (2-page, ElixaX at bottom)',
  description: 'Same as Standard, but with ElixaX Health moved to the bottom as a personal project. Best for enterprise / corporate applications.',
  filename: 'Jayshri-Dalvi-Resume-ElixaX-Last.docx',
};
