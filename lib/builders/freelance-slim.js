...
export const meta = {
  id: 'freelance-slim',
  name: 'Freelance — Slim',
  description: 'Slim freelance/Upwork-friendly variant. Includes SERVICES + CORE SKILLS sections, compact layout.',
  filename: 'Jayshri-Dalvi-Resume-Freelance-Slim.docx',
};
