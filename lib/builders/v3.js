...
export function buildDocument() {
  const sections = [{
    ...
    children: [
      ...
      sectionHeader('FEATURED PROJECT — ElixaX Health  ·  Founder, Solo Build  ·  Jan 2026 – Present'),
      new Paragraph({
        spacing: { after: 30 },
...
export const meta = {
  id: 'v3',
  name: 'Standard (2-page, ElixaX featured)',
  description: 'Clean 2-page resume with ElixaX Health as a featured project near the top. Best for general applications.',
  filename: 'Jayshri-Dalvi-Resume.docx',
};
